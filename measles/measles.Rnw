...
%\lstset{breaklines=true,showstringspaces=false} % break long lines
...
\begin{frame}[fragile]
\frametitle{Implementation of the process model I}
...
\begin{frame}[fragile]
\frametitle{Implementation of the process model II}
<<rprocess2, echo = FALSE, tidy = TRUE>>=
cat(rproc2,sep='\n')
@
\end{frame}

\begin{frame}[fragile]
\frametitle{Implementation of the process model III}
<<rprocess3, echo = FALSE, tidy = TRUE>>=
cat(rproc3,sep='\n')
@
\end{frame}
...
\item Produced in \myemph{R} version \Sexpr{getRversion()} using \package{pomp} version \Sexpr{packageVersion('pomp')}.

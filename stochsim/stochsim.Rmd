...
#  label=c(expression(lambda),expression(gamma)),gp=gpar(fontsize=18))
#label=c(expression(mu_[SI]),expression(mu_[IR])),gp=gpar(fontsize=18))
...
measSIR %>% 
  simulate(params=c(Beta=8,gamma=0.5,rho=0.5,N=38000,eta=1/10))
```

...
```{r euler,echo=FALSE,fig.height=3,fig.cap="Euler approximations $\\tilde x(t)$ with stepsize 0.1 (A) and 0.05 (B) are shown in blue. The true solution, $x(t)$, is shown in black."}

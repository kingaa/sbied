...
pomp(bsflu[c("day","B")],times="day",t0=-6,
...
simulate(flu,nsim=20,as.data.frame=TRUE,include.data=TRUE) -> simdat
ggplot(data=subset(simdat,select=c(time,B,sim)),
       mapping=aes(x=time,y=B,color=(sim=="data"),
                   size=(sim=="data"),group=sim))+
  geom_line()+

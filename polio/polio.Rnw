...
\frametitle{Reviewing covariates in time series analysis}
...
if(run_level>1) write.table(
  r3,file="polio_params_out.csv",append=TRUE,col.names=FALSE,row.names=FALSE)
...
<<profile_rho_plot1,echo=F,fig.width=6,fig.height=6,out.width="10cm">>=

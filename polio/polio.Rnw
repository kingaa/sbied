...
<<pf1>>=
stew(file=sprintf("results/pf1-%d.rda",run_level),{
  t1 <- system.time(
...
\ei
<<persistence-sim>>=
stew(sprintf("results/persistence-%d.rda",run_level),{
  t_sim <- system.time(
...
<<mif>>=
stew(sprintf("results/mif-%d.rda",run_level),{
  t2 <- system.time({
...
<<box_eval>>=
stew(file=sprintf("results/box_eval-%d.rda",run_level),{
  t3 <- system.time({

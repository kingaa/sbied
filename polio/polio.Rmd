...
This investigation took `r round(t1["elapsed"]/60,1)` minutes on a machine with `r getDoParWorkers()` cores.
...
It took about `r round(t2[3]/60)` mins on a `r getDoParWorkers()`-core machine.

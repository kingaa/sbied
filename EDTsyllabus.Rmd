...
<div class="nb">
***Times are EDT: Pacific Daylight (Seattle) Time (UTC-07:00) plus `r EDT` hr***  
...
**Session 1**  
`r 8+EDT`:00--`r 8+EDT`:30: Introductions. Organization. Lessons 1 and 2 Q&A.  
`r 8+EDT`:30--`r 9+EDT`:45: Breakout groups work on Exercises 2.3 & 2.4.  
`r 9+EDT`:45: Breakout group progress reports due on Slack.  
`r 9+EDT`:45-`r 10+EDT`:15: Live plenary discussion of breakout group results.  

**Interlude**  
`r 10+EDT`:15--`r 12+EDT`:15: View lecture videos for [Lesson 3](https://kingaa.github.io/sbied/pfilter/) (c.&nbsp;112min or 75min at 1.5x).  
- Send questions to Instructors via Slack.  
`r 11+EDT`:45--`r 12+EDT`:15: Optional office hour (for those who have finished watching the Lesson 3 videos).  

**Session 2**  
`r 12+EDT`:15--`r 12+EDT`:45: Lesson 3 Q&A.  
`r 12+EDT`:45--`r 14+EDT`:00: Breakout groups work on Exercises 3.1--3.4.  
`r 14+EDT`:00: Breakout group progress reports due on Slack.  
`r 14+EDT`:00--`r 14+EDT`:30: Live plenary discussion of breakout group progress.  
...
**Session 3**  
`r 8+EDT`:00--`r 8+EDT`:30: Lesson 4, Parts I--IV Q&A.  
`r 8+EDT`:30--`r 9+EDT`:45: Breakout groups work on Exercises 4.1 & 4.2.  
`r 9+EDT`:45: Breakout group progress reports due on Slack.  
`r 9+EDT`:45--`r 10+EDT`:15: Live plenary discussion of breakout group progress.

**Interlude**  
`r 10+EDT`:15--`r 12+EDT`:15: View lecture videos for [Lesson 4, Parts V--VI](https://kingaa.github.io/sbied/mif/) (c.&nbsp;55min or 38min at 1.5x).  
- Send questions to Instructors via Slack.  
`r 11+EDT`:45--`r 12+EDT`:15: Optional office hour (for those who have finished watching the Lesson 4 videos).  

**Session 4**  
`r 12+EDT`:15--`r 12+EDT`:45: Lesson 4, Parts V-VI Q&A.  
`r 12+EDT`:45--`r 14+EDT`:00: Breakout groups work on Exercises 4.1--4.4.  
`r 14+EDT`:00: Breakout group progress reports due on Slack.  
`r 14+EDT`:00--`r 14+EDT`:30: Live plenary discussion of breakout group progress.  
...
**Session 5**  
`r 8+EDT`:00--`r 8+EDT`:30: Lesson 5 Q&A.  
`r 8+EDT`:30--`r 9+EDT`:30: Breakout groups develop consensus answers to the Quiz questions and select two research questions for the instructors from the group.  
`r 9+EDT`:30: Breakout group reports due on Slack.  
`r 9+EDT`:30--`r 10+EDT`:30: Plenary discussion.  
`r 10+EDT`:30--`r 11+EDT`:00: Concluding remarks.  
`r 11+EDT`:00--`r 12+EDT`:00: Optional drop-in session: all topics welcomed.  

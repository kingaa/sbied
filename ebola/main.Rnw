...
\begin{frame}[fragile,allowframebreaks]{Parameter estimates}
  ...
  \item 
    Codes for this document are \link{https://raw.githubusercontent.com/kingaa/sbied/master/ebola/codes.R}{available here}.
...
\begin{frame}[fragile,allowframebreaks]{Process noise and measurement error}
  ...
  See \link{https://raw.githubusercontent.com/kingaa/sbied/master/ebola/codes.R}{this lesson's \Rlanguage script} for details.
...
\begin{frame}{License, acknowledgments, and links}
  ...
  \link{https://raw.githubusercontent.com/kingaa/sbied/master/ebola/codes.R}{\Rlanguage codes for this lesson}
\end{frame}

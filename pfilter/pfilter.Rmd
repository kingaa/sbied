...
Measurements, $Y_n$, at time $t_n$ depend only on the state, $X_n$, at that time.
State variables depend only on state variables at the previous timestep.
...
[Download a script containing the **R** commands below.](http://raw.githubusercontent.com/kingaa/sbied/master/pfilter.R)

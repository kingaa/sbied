...
\begin{frame}[allowframebreaks]{Overview}
  ...
  <<flow-diagram,dpi=200,fig.width=4.5,fig.align="center",echo=FALSE,results="hide",purl=FALSE,out.width="0.5\\textwidth">>=
  library(diagram)
  par(mar = c(1, 1, 1, 1))
  openplotmat()
...
\begin{frame}{Special case: deterministic latent process}
  ...
  \item More details on deterministic latent process models are given as a \href{deterministic.html}{\textcolor{blue}{supplement}}.
  \end{itemize}
\end{frame}

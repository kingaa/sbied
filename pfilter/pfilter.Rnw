...
\begin{frame}{The likelihood function}
  ...
  \item Method of maximum likelihood introduced by \citep{Fisher1922}.
  \item The likelihood function itself is a representation of the what the data have to say about the parameters.
  \item A good general reference on likelihood is by \citep{Pawitan2001}.
  \end{itemize}
\end{frame}
...
\begin{frame}{License and acknowledgments}

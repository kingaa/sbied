...
\begin{frame}{Profile likelihood estimation}
  ...
  We will explain this method below and put it into practice in the \href{../mif/mif.pdf}{\textcolor{blue}{next lesson}}.
\end{frame}
...
\begin{frame}{License and links}
  ...
  \href{https://raw.githubusercontent.com/kingaa/sbied/master/mif/mif.R}{\textcolor{blue}{\Rlanguage code for this lesson}}\\
\end{frame}

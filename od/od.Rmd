...
We will not report the debugging and short-run values of subsequent parameters.
...
bake(file="lik_local.rds",{
  ...
  {
    evals <- replicate(N_LIK_REPS, logLik(pfilter(mf,Np=NP)))

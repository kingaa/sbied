...
* We may work with experimental or observational data:
    + For population-level epidemiological dynamics, data are usually observational.
    + For observational data, we must be cautious about inferring causality.
        * Association is not causation.
        * if $X$ appear to cause $Y$, could they both be determined by an unmeasured $Z$?
        * Known biological mechanisms can support the structure of mechanistic, causal models.
...
![state_space_diagram1](../graphics/state_space_diagram1.png)
...
```{r ssdiag2,echo=FALSE,out.width="1200px",purl=FALSE}
library(grid)
...
[Download a script containing the **R** commands below.](http://raw.githubusercontent.com/kingaa/sbied/master/intro/intro.R)

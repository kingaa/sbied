...
1. to introduce the concept of partially observed Markov process models as a tool for scientific investigation and public health policy
1. to give students the ability to formulate models of their own
1. to teach efficient approaches for performing scientific inference using such models
...
1. Session 6 (Thurs. 3:30-5:00): Diagnostics and model criticism
...
2. [Simulating dynamic models: the stochastic Euler method.](./stochsim/stochsim.html)
3. [The particle filter: theory and practice](./pfilter/pfilter.html)
1. Principles of likelihood-based inference.
1. [Iterated filtering: theory and practice](./mif/mif.html)
1. Diagnostics and model criticism

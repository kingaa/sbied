...
The archives store not only the results, but also information about the time elapsed and the number of CPUs used.
...
For example, the following shows the poor man's profile over $\mu_{EI}$.
Consult [the **R** script for this document](./Q_fit_seir.R) to see how it is computed.

```{r poor_mans_profile_eta}
#| echo: false
#| fig.height: 6
all %>%
  mutate(

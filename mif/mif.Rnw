...
\title{Lesson 3.\\Iterated filtering: principles and practice}
...
\begin{frame}{Introduction}
  ...
  \item This tutorial follows on from the \href{../pfilter/pfilter.html}{\textcolor{blue}{topic of particle filtering}} (also known as sequential Monte Carlo) via \code{pfilter} in \package{pomp}. 
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile,allowframebreaks]{Expanding the search}
  ...
  See the \href{https://raw.githubusercontent.com/kingaa/sbied/master/mif/mif.R}{\textcolor{blue}{\Rlanguage code for this lesson}} to see exactly how this is done.
...
\begin{frame}{Extra Exercise: Choosing the algorithmic settings for IF2}
  Have a look at \href{./if2_settings.html}{\textcolor{blue}{our advice on tuning IF2}}.
\end{frame}
